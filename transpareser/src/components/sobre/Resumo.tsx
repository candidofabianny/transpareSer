...
const Resumo = () => {
  return (
    <section id="resumo"
    className="bg-[url('../assets/images/sobre/bgresumo.png')] bg-cover bg-bottom justify-center items-center flex flex-col h-full w-full py-10 md:py-20 lg:min-h-[470px]">    
