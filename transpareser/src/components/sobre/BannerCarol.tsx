...
const BannerCarol = () => {
  return (
    <section id="banner"
    className="bg-[url('../assets/images/sobre/@transpareser.png')] bg-fixed bg-center bg-cover flex flex-col items-center justify-center min-h-[177px] md:min-h-[226px] w-full">    
