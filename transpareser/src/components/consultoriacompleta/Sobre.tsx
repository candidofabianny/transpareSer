  ...
  return (
    ...
    className="bg-[#F9F9F9] justify-center items-center flex flex-col w-full pt-16 pb-12 md:pb-12">    
        <div className="flex flex-col md:flex-row items-center justify-center gap-14">
            ...
            src={sobre} />
            <div className="collapse collapse-plus bg-base-200 mb-4 max-w-[95%] md:max-w-[100%]">
          ...
          <div className="collapse collapse-plus bg-base-200 mb-4 max-w-[95%] md:max-w-[100%]">
            ...
            <Image
            alt="gallery"
            className="hidden md:block mr-6 md:mr-14 h-[486px] w-[290px] lg:w-[320px] object-fill"
            src={sobre} />
             </div>
      </section>
  );
