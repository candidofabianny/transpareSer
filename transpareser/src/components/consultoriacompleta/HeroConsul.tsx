...
const HeroConsultoria = () => {
  ...
  return (
    ...
    className="flex flex-col justify-end w-full">  
         <div className="bg-[#A11E1E] md:flex md:flex-row items-center justify-center pt-28 md:pt-12 lg:pt-24 text-center min-h-[500px]">
              ...
              <Link className="bg-[#BD4646] transition ease-in-out rounded-full text-white text-[1.55rem] px-10 py-4 mb-8 place-self-center hover:bg-[#7E0505]" href="">Adquira já</Link>
              </div>
              </div>
           </div>
      </section>
