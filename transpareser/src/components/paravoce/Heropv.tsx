...
const Heropv = () => {
  return (
    ...
    className="bg-[url('../assets/images/paravoce/bgparavoce.png')] bg-cover bg-center flex flex-col items-center justify-center min-h-[655px] w-full">    
        <div className="bg-black/60 min-h-[665px] w-full flex flex-col md:flex-row items-center justify-center">
        ...
        <div className={`${autography.className}`}>
          <h1 className="text-[4.5rem] text-white text-center leading-7 pt-26 pb-4 hidden md:block lg:mr-[200px]">Para Você</h1>
        </div> 
