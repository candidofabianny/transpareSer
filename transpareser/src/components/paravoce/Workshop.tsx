  ...
  return (
    ...
    className="bg-[#181515] justify-center items-center flex flex-col w-full pt-14 pb-2">    
        ...
        <div className={`${barcelony.className}`}>
           <p className="md:hidden text-[2.9rem] tracking-tight text-center">Workshop Estilo Autêntico</p>
           </div>
          ...
          <Image
            ...
            <div className={`${barcelony.className}`}>
            <p className="text-[3rem] lg:text-[3.9rem] tracking-tighter pb-10 text-center lg:text-left">Workshop Estilo Autêntico</p></div>
