...
import button from "/src/assets/images/paravoce/buttonworkshop.png"
  ...
  return (
    ...
    className="bg-[#181515] justify-center items-center flex flex-col w-full -mt-1 pb-12">    
        ...
        <div className={`${orleymore.className}`}>
          ...
          <Image
            alt="gallery"
            className="md:hidden h-[390px] w-[280px] -mt-4"
            src={button} /></Link>
            <Image
            alt="gallery"
            className="hidden md:block w-[280px] h-[360px] lg:w-[318px] lg:h-[400px] md:ml-6"
            src={workshop} />
