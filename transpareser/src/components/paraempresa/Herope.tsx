...
const HeroConsultoria = () => {
  return (
    <section className="bg-[url('../assets/images/paraempresa/paraempresa.jpeg')] bg-cover bg-start flex flex-col justify-center min-h-[625px] w-full">    
        ...
        Invista na sua equipe e na relação com suas clientes
        </h1>
        </div>
        </div>      
      </section>
