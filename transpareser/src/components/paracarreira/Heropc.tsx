...
const Heropc = () => {
  return (
    <section className="bg-[url('../assets/images/paracarreira/parasuacarreira.jpeg')] bg-cover bg-center flex flex-col items-center justify-center min-h-[605px] w-full">    
