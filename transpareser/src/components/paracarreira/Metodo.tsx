...
const Metodo = () => {
  return (
    <section id="home"
    className="bg-[#181515] justify-center items-center flex flex-col w-full -mt-1 pb-2">    
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-4 lg:gap-8 pt-6 text-white">
        <div className={`${barcelony.className}`}>
           <p className="md:hidden text-[2.9rem] tracking-tight text-center">Metodo TranspareSer</p>
           </div>
          ...
          <Image
            ...
            <div className={`${barcelony.className}`}>
            <p className="text-[3rem] lg:text-[3.9rem] tracking-tighter pb-10 text-center lg:text-left">Método TranspareSer</p></div>
